...
DIST          = .gitignore \
		...
		FontManager.h \
		src/partymanager/PartyManager.h GameStateManager.cpp \
		AudioManager.cpp \
		blacklands.cpp \
		TheCity.cpp \
		src/network_manager/NetworkManager.cpp \
