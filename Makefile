...
DIST          = .gitignore \
		...
		GameStateManager.h \
		src/event/EventManager.h game_menu.cpp \
		src/hall_of_records/hallofrecordsdialog.cpp \
		src/create_character/createcharacterdialog.cpp \
		src/about_dialog/AboutDialog.cpp \
		src/character_dialog/CharacterDialog.cpp \
